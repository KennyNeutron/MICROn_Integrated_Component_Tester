...
void disp_74LS32_TestResult_exit() {
  disp_74LS32_TestResult_init = false;
...
bool get_TestResult_74LS32_LG1() {
...
bool get_TestResult_74LS32_LG2() {
...
bool get_TestResult_74LS32_LG3() {
...
bool get_TestResult_74LS32_LG4() {
...
void disp_74LS32_TestResult_INIT() {
  ...
  Serial.println("\n\n\nLooking For ERRORS");
  //TEST LG1
  if (!get_TestResult_74LS32_LG1()) {
    Serial.println("LG1 ERROR");
    str_ErrorGate = str_ErrorGate + " LG1";
    errorLG1 = true;
    NumOf_ErrorGate++;
  }
  if (!get_TestResult_74LS32_LG2()) {
  ...
  Serial.println("\n\n\n******74LS32 Test Results******");
  Serial.println("\nLogic Gate #1: " + String(get_TestResult_74LS32_LG1()));
  Serial.println("Logic Gate #2: " + String(get_TestResult_74LS32_LG2()));
  Serial.println("Logic Gate #3: " + String(get_TestResult_74LS32_LG3()));
  Serial.println("Logic Gate #4: " + String(get_TestResult_74LS32_LG4()));
  ...
  display_TitleBar("Integrated Circuit TESTER", "74LS32 TEST RESULT");
  ...
  */
  ...
  disp_74LS32_TestResult_init = true;
  blink_last_millis = millis();
}