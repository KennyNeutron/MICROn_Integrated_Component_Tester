//Screen: TEST IC 74LS00
//Screen ID: 0x1410

bool disp_74LS00_TestResult_init = false;
bool ICtest_74LS00_done = false;

void disp_74LS00_TestResult() {
  if (!disp_74LS00_TestResult_init) {
    disp_74LS00_TestResult_INIT();
  }
...
void disp_74LS00_TestResult_exit() {
  disp_74LS00_TestResult_init = false;
  ICtest_74LS00_done = false;
...
bool get_TestResult_74LS00_LG1() {
...
bool get_TestResult_74LS00_LG2() {
...
bool get_TestResult_74LS00_LG3() {
...
bool get_TestResult_74LS00_LG4() {
...
void disp_74LS00_TestResult_INIT() {
  ...
  Serial.println("\n\n\nLooking For ERRORS");
  //TEST LG1
  if (!get_TestResult_74LS00_LG1()) {
    Serial.println("LG1 ERROR");
    str_ErrorGate = str_ErrorGate + " LG1";
    errorLG1 = true;
    NumOf_ErrorGate++;
  }
  if (!get_TestResult_74LS00_LG2()) {
  ...
  Serial.println("\n\n\n******74LS00 Test Results******");
  Serial.println("\nLogic Gate #1: " + String(get_TestResult_74LS00_LG1()));
  Serial.println("Logic Gate #2: " + String(get_TestResult_74LS00_LG2()));
  Serial.println("Logic Gate #3: " + String(get_TestResult_74LS00_LG3()));
  Serial.println("Logic Gate #4: " + String(get_TestResult_74LS00_LG4()));
  ...
  display_TitleBar("Integrated Circuit TESTER", "74LS00 TEST RESULT");
  ...
  */
  ...
  ICtest_74LS00_done = true;

  disp_74LS00_TestResult_init = true;
  blink_last_millis = millis();
}