//Screen: Test IC 74LS47
//Screen ID: 0x1810

bool disp_74LS47_TestResult_init = false;
bool ICtest_74LS47_done = false;

void disp_74LS47_TestResult() {
  if (!disp_74LS47_TestResult_init) {
    disp_74LS47_TestResult_INIT();
  }
  ...
  if (!btn_Home_pressed && btn_pressed > 0) {
    ...
    disp_74LS47_TestResult_exit();
  }
}


void disp_74LS47_TestResult_exit() {
  disp_74LS47_TestResult_init = false;
  ICtest_74LS47_done = false;
...
void disp_74LS47_TestResult_INIT() {
  Serial.println("74LS47 IC test Result");
  ...
  if (BCD_7Segment_Out[0] == 1 && BCD_7Segment_Out[1] == 79 && BCD_7Segment_Out[2] == 18 && BCD_7Segment_Out[3] == 6 && BCD_7Segment_Out[4] == 76 && BCD_7Segment_Out[5] == 36 && BCD_7Segment_Out[6] == 96 && BCD_7Segment_Out[7] == 15 && BCD_7Segment_Out[8] == 0 && BCD_7Segment_Out[9] == 12) {
    bad_ic = false;
  } else {
    bad_ic = true;
  }
  ...
  display_TitleBar("Integrated Circuit TESTER", "74LS47 TEST RESULT");
  ...
  bmp_file = SD.open(file_name[14]);
  draw_bmp_picture(bmp_file, 50, 110);
  bmp_file.close();
  disp_74LS47_TestResult_init = true;
}